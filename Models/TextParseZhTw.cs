namespace Church.BibleStudyFellowship.Models
{
    ...
    public class TextParseZhTw : ITextParser
    {
        ...
        internal TextParseZhTw(int year, CultureInfo culture, Regex versePattern, IDictionary<Regex, MethodInfo> methodMappings)
        {
            this.Year = year;
        ...
        public static TextParseZhTw Create(int year, IRepository repository)
        {
            ...
            var versePattern = TextParseZhTw.GetBibleVersePattern(repository, culture.Name);

            return new TextParseZhTw(year, culture, versePattern, methodMappings);
        }
